      ...
      <View style={styles.mainView}>
          ...
          <View style={styles.MainProfileDetails}>
            <View style={{ flexDirection: "row" }}>
              ...
              <View style={{ alignSelf: "center" }}>
                ...
                {this.state.user && this.state.user.address}, {this.state.user && this.state.user.city}
                </Text>
              </View>
            </View>
          </View>
        ...
        <View style={styles.MainProfileDetail}>
          <ScrollView>
            ...
            <TouchableOpacity  onPress={()=>this.props.navigation.navigate("CurrentOrderDB")} style={styles.OrderHistroyMainBg}>
              ...
              <View style={{ flexDirection: "row" }}>
                ...
                <Text style={styles.OrderHistoryText}>Current Order</Text>
              </View>
