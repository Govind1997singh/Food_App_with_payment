...
export default class WelcomeScreenRes extends Component {
...
//       var AA = this.state.res
      
//       this.state.res.map((item, index)=>{

//         // alert(item)
//        firestore().collection('allusers').doc(this.state.uid)
//       .collection("Favorites")
// .where("id", "==", item.id)
//       // .collection("Favorites")
//       // .where("id", "==", "FjRzrQPPuKEjtWzPBSGk")
//       .get()
//       .then(querySnapshot => {
//         if(querySnapshot.docs.length == 1){
//           // .push({...AA[index],is_Favorite  : true})
//           AA[index].is_Favorite  = true  
//         }
      ...
      <View style={styles.mainView}>
        ...
        >
          <ScrollView>
            ...
            <View style={{...styles.SearchBg, borderWidth:1, marginVertical:10, borderColor:"#f05522", height:50, display:'none'}}>
              <AntDesign
                name="search1"
                size={20}
                color="#c2c4ca"
